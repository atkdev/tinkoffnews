...
fun createBaseModule(appContext: Context) =
    applicationContext {
        bean { RetrofitFactory.createRetrofit().create(NewsApi::class.java) }
        bean("cachePath") { appContext.cacheDir }
    }
...
val newsListModule = applicationContext {
...
val newsContentModule = applicationContext {
